import { useRef, useEffect, useContext, useState, useMemo } from 'preact/hooks';
import { isFunction, get, set, reduce, find, keys, forEach, isNumber, debounce, some, sortBy, has } from 'min-dash';
...
export { index$2 as BpmnPropertiesPanelModule, index$1 as BpmnPropertiesProviderModule, index as ZeebePropertiesProviderModule, useService };
